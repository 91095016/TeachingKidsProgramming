      ...
      MouseRightClickListener
{
  ...
  {
    Text single = new Text("Single!");
    single.setPenColor(PenColors.Yellows.Yellow);
    single.setTopLeft(155, 135).addTo(Tortoise.getBackgroundWindow());
  }
  @Override
  ...
  {
    Text homeRun = new Text("Home Run!");
    homeRun.setPenColor(PenColors.Greens.LimeGreen);
    homeRun.setTopLeft(105, 235).addTo(Tortoise.getBackgroundWindow());
  }
